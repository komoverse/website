...
<div class="container-fluid p-0">
    <h3 class="mb-3">Create New Game Announcement</h3>
    <form action="{{ url('admin/game-announcement/create') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-9 mb-2">
                <div class="input-group">
                    <span class="input-group-text" id="basic-addon3">{{ url('/') }}/announcement/</span>
        ...
        <div class="row">
            <div class="col-12 col-lg-3">
                Thumbs Image URL (200 x 80 pixels)
            </div>
            <div class="col-12 col-lg-9 mb-2">
                <input type="text" name="thumb_image" placeholder="Image URL" class="form-control">
                <a href="{{ url('admin/media') }}" target="_blank"><i class="fas fa-share"></i>  Open Media Uploader in New Tab</a>
            </div>
        </div>
        <div class="row">
