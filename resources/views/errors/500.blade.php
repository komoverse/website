...
<head>
    ...
    <!--script src="{{ url('assets/js/taptap-menu.js') }}"></script-->
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-213457209-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-213457209-1');
</script>
<body>
...
<div class="d-flex flex-column min-vh-100 justify-content-center align-items-center">
    ...
    <h1 style="font-size: 7rem">500</h1>
