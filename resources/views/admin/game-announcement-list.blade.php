...
<div class="container-fluid p-0">
    <div class="row">
        <div class="col-12">
            <h2>Latest Game Announcement</h2>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-12 col-lg-4 text-end">
            <a href="{{ url('admin/game-announcement/create') }}" class="btn btn-success"><i class="fas fa-plus"></i> &nbsp; Create Game Announcement Article</a>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
