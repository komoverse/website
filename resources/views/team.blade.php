...
Educated in Germany, Toto is an accomplished IT veteran who began his career in a software company before founding Sigma in 1989. He also founded Indonesia’s first Internet Service Provider, Indonet in 1994, and holds an advisory role for Bursa Efek Indonesia.";
    $totobio['id'] = "Toto Sugiri adalah salah satu pengusaha teknologi paling awal dan paling berpengaruh di Indonesia. Toto adalah pendiri dan CEO perusahaan Data Center terbesar di negara ini—DCI. Dia bertanggung jawab atas keseluruhan bisnis dan merupakan titik komunikasi utama dengan stakeholder utama, termasuk investor, mitra, pelanggan, dan publik.

Dididik di Jerman, Toto adalah seorang veteran IT handal yang memulai karirnya di sebuah perusahaan perangkat lunak sebelum mendirikan Sigma pada tahun 1989. Ia juga mendirikan Penyedia Layanan Internet pertama di Indonesia, Indonet pada tahun 1994, dan memegang peran sebagai penasihat di Bursa Efek Indonesia.";
...
Toto Sugiri 早前在德国接受教育，是一位成就卓著的 IT 资深人士，在 1989 年创立 Sigma 之前，他的职业生涯始于一家软件公司。他在 1994 年创立了印尼第一家互联网服务提供商 Indonet，并在 Bursa Efek Indonesia 担任顾问职务。";
    ...
    // $sharlenetitle['zh'] = '资深设计师';

    // $sharbio['en'] = "Sharlene Putihrai is the Senior Designer of Summertime Studios. Her passion for business and art has driven her shift into the creative industry. She has been involved in the creation and marketing of few brands, NFT projects, and has a background in finance.";
    // $sharbio['id'] = "Sharlene Putihrai adalah Desainer Senior di Summertime Studios. Ketertarikannya pada bisnis dan seni membuatnya berpindah ke industri kreatif. Dia telah terlibat dalam pembuatan dan marketing beberapa merek, proyek NFT, dan memiliki latar belakang di bidang keuangan.";
    // $sharbio['zh'] = "";

    // $herytitle['en'] = 'Animator';
    // $herytitle['id'] = 'Animator';
    // $herytitle['zh'] = '动画师';

    // $herybio['en'] = "Heryagus is the video editor and 2D artist of Summertime Studios.  he has a bachelor's degree majoring in dkv animation. He specializes in 2D animation, and really likes editing visual effects.  he's experienced in video editing, visual effects, and animation. he really likes to study visual effects, and likes animated films to learn things and insights.";
    // $herybio['id'] = "Heryagus bekerja sebagai Video Editor dan 2D Artist di Summertime Studios. Ia adalah lulusan Sarjana jurusan DKV Animation, yang menekuni bidang 2D animation dan efek visual. Ia juga sudah memiliki pengalaman dalam melakukan pengeditan video, efek visual dan animasi. Heryagus senang untuk terus mempelajari bidang efek visual dan animasi film ini untuk menambah perspektif dan pandangan yang baru.";
    // $herybio['zh'] = "";

    // $mikailatitle['en'] = 'Social Media';
    // $mikailatitle['id'] = 'Media Sosial';
    // $mikailatitle['zh'] = '社交媒体';

    // $mikailabio['en'] = "Mikaila Pranaya Wibowo is a highly organized and dedicated student at the Tourism Vocational Program, University of Indonesia. Other than that, she gets along with people and adjust to changes with ease. Adapt to various social media platforms and office technology programs. Committed to utilizing her skills to further the mission of a company.";
    // $mikailabio['id'] = "Mikaila adalah mahasiswa di Universitas Indonesia jurusan Tourism Vocational Program yang berdedikasi tinggi. Ia mudah beradaptasi dengan orang baru dan cepat belajar dalam memahami berbagai macam platform social media dan program office technology. Mikaila berkomitmen untuk menggunakan kemampuannya dalam memenuhi misi dari perusahaan dan juga client-nya.";
    // $mikailabio['zh'] = "";

    // $jacqtitle['en'] = 'Art Director';
    // $jacqtitle['id'] = 'Direktur Seni';
    // $jacqtitle['zh'] = '艺术指导';

    // $jacqbio['en'] = "Jacqueline Natasha is the art director of Summertime Studios. She found her passion in bringing brands to their fullest potentials through identity exploration, productions, print, and digital productions. She believes design has the power to tell stories, evoke emotions, spark engagement, transform and grow business. Started her design journey as an interior designer, brought her deep understanding of styling and content creations.";
    // $jacqbio['id'] = "Jacqueline adalah seorang Art Director di Summertime Studios. Ia menemukan kegemarannya membawa setiap brand untuk memaksimalkan potensial mereka dalam mengeksplorasi identitas, menjalankan produksi, mencetak dan juga membuat produk digital. Ia percaya bahwa setiap desain memiliki kekuatan untuk bercerita, membangkitkan perasaan, memicu keterikatan, mengubah dan mengembangkan bisnis. Jacqueline memulai perjalanan desainnya sebagai seorang desainer interior, yang membangunkan pemahamannya dalam melakukan pembuatan konten.";
    // $jacqbio['zh'] = "";

    // $irawantitle['en'] = 'Cinematographer';
    // $irawantitle['id'] = 'Sinematografer';
    // $irawantitle['zh'] = '电影摄影师';

    // $irawanbio['en'] = "Irawan Arioseno is the Director of Photography of Summertime Studios. A creative agency who has worked with various brands, such as Nivea, Sandimas, Ikkudo Ichi, etc. He involves with numerous projects in assisting creating storyboard, creative content and editing final production.";
    // $irawanbio['id'] = "Irawan menjabat sebagai Director of Photography di Summertime Studios, yang sudah bekerjasama dengan berbagai macam brand, diantaranya adalah Nivea, Sandimas, Ikkudo Ichi, dan masih banyak lagi. Ia terlibat dalam berbagai macam proyek pembuatan storyboards, konten-konten kreatif, dan pembuatan produksi akhir.";
    // $irawanbio['zh'] = "";

    // $natalietitle['en'] = 'Public Relations';
    // $natalietitle['id'] = 'Relasi Publik';
    // $natalietitle['zh'] = '公关';

    // $nataliebio['en'] = "Natalie Suryadi is an undergraduate student, studying Digital Cultures & Marketing. She has been involved with lots of social media management work and public relations. Shes experienced in content creating, video editing, and creative directing. She loves to explore new things and meeting people.";
    // $nataliebio['id'] = "Natalie merupakan seorang mahasiswa yang mempelajari Digital Cultures & Marketing. Ia sudah terlibat dalam proyek manajemen sosial media dan public relations. Ia juga berpengalaman dalam pembuatan konten, pengeditan video, dan creative directing. Ia senang mengeksplorasi hal baru dan bertemu orang-orang.";
    // $nataliebio['zh'] = "";

    // $josephinetitle['en'] = 'Copywriter';
    // $josephinetitle['id'] = 'Penulis';
    // $josephinetitle['zh'] = '文案作者';

    // $josebio['en'] = "Josephine Henata, an undergraduate student in Communication Studies, specializes in copywriting and Public Relations. She has been writing promotional contents for numerous renowned brands, namely Samsung, Hyundai, And TikTok. Her main interest is to connect with new people and to build relations with them.";
    // $josebio['id'] = "Josephine adalah mahasiswa jurusan Communication Studies, yang merupakan spesialisasi di bidang Copywriting and Public Relations. Ia sudah menulis berbagai macam konten promosi untuk sejumlah brand ternama seperti Samsung, Hyundai dan TikTok. Keinginan utamanya adalah untuk mencari koneksi dan membangun relasi dengan orang baru.";
    // $josebio['zh'] = "";

    // $danartitle['en'] = 'Video Editor';
    // $danartitle['id'] = 'Editor Video';
    // $danartitle['zh'] = '视频编辑';

    // $danarbio['en'] = "Danar Respati is the Videographer and Editor of Summertime Studios. His passion in creativity make him always try to create joy and happiness behind the lens. He's experienced in producing, video editing and film making. He always eager to do more and more beyond what he have to make the best result that everyone can enjoy.";
    // $danarbio['id'] = "Danar adalah seorang Videographer dan Editor di Summertime Studios. Kreativitasnya membawa Danar untuk terus berusaha menciptakan suatu kegembiraan di balik layar kamera. Ia berpengalaman dalam melakukan produksi, pengeditan video dan pembuatan film. Ia juga memiliki keinginan untuk terus melakukan hal-hal yang melampaui batas agar dapat mencapai hasil terbaik.";
    // $danarbio['zh'] = "";
    ...
    // $andrewbio['zh'] = "国际畅销书作家、以及由马来西亚国家图书馆颁发Dana Penulis奖的两届获奖者。Andrew目前正在马来西亚资源开发基金（HRDF）讲授有关金融智能的新学科。他也参与了有关加密货币和NFT的交易。";
        ...
        <div class="col-lg-8">
            <div class="row row-cols-1 row-cols-lg-2 g-4 border-team">
                ...
                <div class="team-wrapper-v2">
                    ...
                    <span>{{ $hendrytitle[$lang] }}</span>
                    <br><i class="fas fa-info" data-bs-toggle="tooltip" data-bs-placement="right" title="{{ $hendrybio[$lang] }}"></i>
                    <a href="https://www.linkedin.com/in/halimhendry/" target="_blank"><i class="fab fa-linkedin"></i></a>
                    <a href="https://instagram.com/hendry.crypto" target="_blank"><i class="fab fa-instagram"></i></a>
                </div>
                <div class="team-wrapper-v2">
                    <img src="{{ url('assets/img/team/dylan.webp') }}" alt="Dylan Photo">
                    <p>Dylan Montana</p>
                    <span>{{ $dylantitle[$lang] }}</span>
                    <br><i class="fas fa-info" data-bs-toggle="tooltip" data-bs-placement="right" title="{{ $dylanbio[$lang] }}"></i>
                    <a href="https://www.instagram.com/dylanmontanas" target="_blank"><i class="fab fa-instagram"></i></a>
                </div>
            </div>
        </div>
        <div class="col-lg-4">
            ...
            <div class="row row-cols-1 row-cols-lg-1 g-4 border-team">
                ...
                <div class="team-wrapper-v2">
                    ...
                    <p>Toto Sugiri</p>
                    <span>{{ $tototitle[$lang] }}</span>
                    <br><i class="fas fa-info" data-bs-toggle="tooltip" data-bs-placement="right" title="{{ $totobio[$lang] }}"></i>
                </div>
            </div>
        </div>
        ...
        <div class="col-12">
            <div class="row row-cols-1 row-cols-lg-3 g-4 border-team">
                ...
                <div class="team-wrapper-v2">
                    ...
                    <p>Nicholas Sean</p>
                    <span>{{ $brandamba[$lang] }}</span>
                    <br><i class="fas fa-info" data-bs-toggle="tooltip" data-bs-placement="right" title="{{ $seanbio[$lang] }}"></i>
                                <a href="https://www.instagram.com/nachoseann/" target="_blank"><i class="fab fa-instagram"></i></a>
                </div>
                <div class="team-wrapper-v2">
                    <img src="{{ url('assets/img/team/jevier.webp') }}" alt="Jevier Photo">
                    <p>Jevier Justin</p>
                    <span>{{ $brandamba[$lang] }}</span>
                    <br><i class="fas fa-info" data-bs-toggle="tooltip" data-bs-placement="right" title="{{ $jevier[$lang] }}"></i>
                                <a href="https://www.instagram.com/jevierjustin/" target="_blank"><i class="fab fa-instagram"></i></a>
                </div>
                <div class="team-wrapper-v2">
                    <img src="{{ url('assets/img/team/drew.webp') }}" alt="Drew Photo">
                    <p>Drew Dota2</p>
                    <span>{{ $drewtitle[$lang] }}</span>
                    <br><i class="fas fa-info" data-bs-toggle="tooltip" data-bs-placement="right" title="{{ $drewbio[$lang] }}"></i>
                                <a href="https://liquipedia.net/dota2/Drew" target="_blank"><i class="fas fa-globe"></i></a>
                </div>
            </div>
        </div>
            ...
            <div class="row border-team">
                ...
                <div class="col-12">
                    <div class="row row-cols-1 row-cols-lg-4 g-4 mt-3">
                        ...
                        <div class="team-wrapper-v2">
                            <img src="{{ url('assets/img/team/nikko.webp') }}" alt="Nikko Photo">
                            <p>Nikko Agustino</p>
                            <span>{{ $nikkotitle[$lang] }}</span>
                            <br><i class="fas fa-info" data-bs-toggle="tooltip" data-bs-placement="right" title="{{ $nikkobio[$lang] }}"></i>
                            <a href="https://www.linkedin.com/in/nikkoagustino"><i class="fab fa-linkedin"></i></a>
                ...
                <div class="col-12">
                    <div class="row row-cols-1 row-cols-lg-4 g-4 mt-3">
                        ...
                        <div class="team-wrapper-v2">
                            ...
                            <br><i class="fas fa-info" data-bs-toggle="tooltip" data-bs-placement="right" title="{{ $firazbio[$lang] }}"></i>
        ...
        <div class="col-lg-12">
            <div class="row row-cols-1 row-cols-lg-6 g-4 border-team">
                ...
                <div class="team-wrapper-v2">
                    ...
                    <p>Anindyo Wishnu</p>
                    <span>{{ $dyotitle[$lang] }}</span>
                    <br><i class="fas fa-info" data-bs-toggle="tooltip" data-bs-placement="right" title="{{ $dyotitle[$lang] }}"></i>

                            <a target="_blank" href="https://anindyowishnu.com/"><i class="fas fa-globe"></i></a>
                            <a href="https://www.linkedin.com/in/anindyo-wishnu-a3a4b8a6/" target="_blank"><i class="fab fa-linkedin"></i></a>
                </div>
                <div class="team-wrapper-v2">
                    <img src="{{ url('assets/img/team/anzar.webp') }}" alt="Anzar Photo">
                    <p>Anzar Fauzi</p>
                    <span>{{ $anzartitle[$lang] }}</span>
                    <br><i class="fas fa-info" data-bs-toggle="tooltip" data-bs-placement="right" title="{{ $anzarbio[$lang] }}"></i>
                </div>
                <div class="team-wrapper-v2">
                    <img src="{{ url('assets/img/team/seto.webp') }}" alt="Seto Photo">
                ...
                <div class="team-wrapper-v2">
                    ...
                    <p>Tarsisius Stanley</p>
                    <span>{{ $stanleytitle[$lang] }}</span>
                    <br><i class="fas fa-info" data-bs-toggle="tooltip" data-bs-placement="right" title="{{ $stanleybio[$lang] }}"></i>
                        <a href="https://www.linkedin.com/in/tarsisius-stanley-1a8726192/" target="_blank"><i class="fab fa-linkedin"></i></a>
                </div>
                <div class="team-wrapper-v2">
                    <img src="{{ url('assets/img/team/rizal.webp') }}" alt="Rizal Photo">
                    <p>Rizal Arifrahman</p>
                    <span>{{ $rizaltitle[$lang] }}</span>
                    <br><i class="fas fa-info" data-bs-toggle="tooltip" data-bs-placement="right" title="{{ $rizalbio[$lang] }}"></i>
                                <a href="https://www.linkedin.com/in/rizal-arifrahman-28721916b/" target="_blank"><i class="fab fa-linkedin"></i></a>
                </div>
                <div class="team-wrapper-v2">
                    <img src="{{ url('assets/img/team/dadi.webp') }}" alt="Dadi Photo">
                    <p>Dadi Ferdiansyah</p>
                    <span>{{ $dadititle[$lang] }}</span>
                    <br><i class="fas fa-info" data-bs-toggle="tooltip" data-bs-placement="right" title="{{ $dadibio[$lang] }}"></i>
                </div>
            </div>
        </div>
        ...
        {{-- <div class="col-lg-8">
            <div class="row row-cols-1 row-cols-lg-4 g-4 border-team">
                ...
                {{-- <div class="team-wrapper-v2">
                    ...
                    <p>Vincent Raditya</p>
                    <span>Marketing</span>
                    <br><i class="fas fa-info" data-bs-toggle="tooltip" data-bs-placement="right" title="{{ $vincentbio[$lang] }}"></i>
                               <a href="https://www.instagram.com/vincentraditya/" target="_blank"><i class="fab fa-instagram"></i></a>
                               <a href="https://www.youtube.com/user/vincentraditya" target="_blank"><i class="fab fa-youtube"></i></a>
                    <a href="https://www.linkedin.com/in/vincent-raditya-a1064713/"><i class="fab fa-linkedin"></i></a>
                </div> --}}
               {{--  <div class="team-wrapper-v2">
                    <img src="{{ url('assets/img/team/kwin.webp') }}" alt="Kwin Photo">
                    <p>Kwin Chand</p>
                    <span>{{ $kwintitle[$lang] }}</span>
                    <br><i class="fas fa-info" data-bs-toggle="tooltip" data-bs-placement="right" title="{{ $kwinbio[$lang] }}"></i>
                    <a href="https://www.linkedin.com/in/stepanuswidjaja/" target="_blank"><i class="fab fa-linkedin"></i></a>
                </div>
                <div class="team-wrapper-v2">
                    <img src="{{ url('assets/img/team/stephanus.webp') }}" alt="Stephanus Photo">
                    <p>Stephanus Widjaja</p>
                    <span>{{ $strategy[$lang] }}</span>
                    <br><i class="fas fa-info" data-bs-toggle="tooltip" data-bs-placement="right" title="{{ $stephbio[$lang] }}"></i>
                    <a href="https://www.linkedin.com/in/stepanuswidjaja/" target="_blank"><i class="fab fa-linkedin"></i></a>
                </div>
                 --}}
                {{-- <div class="team-wrapper-v2">
                    <img src="{{ url('assets/img/team/andrew.webp') }}" alt="Andrew Photo">
                    <p>Andrew Chia</p>
                    <span>{{ $strategy[$lang] }}</span>
                    <br><i class="fas fa-info" data-bs-toggle="tooltip" data-bs-placement="right" title="{{ $andrewbio[$lang] }}"></i>
                    <a href="https://facebook.com/andrewchia09" target="_blank"><i class="fab fa-facebook"></i></a>
                </div> --}}
{{--             </div>
        </div>
        <div class="col-lg-4">
            <div class="row row-cols-1 row-cols-lg-2 g-4 border-team">
                ...
                <div class="team-wrapper-v2">
                    ...
                    <p>Tommy Hendrawan</p>
                    <span>{{ $moderator[$lang] }}</span>
                    <br><i class="fas fa-info" data-bs-toggle="tooltip" data-bs-placement="right" title="{{ $tommybio[$lang] }}"></i>
                        <a href="https://www.linkedin.com/in/tommyhendrawan/" target="_blank"><i class="fab fa-linkedin"></i></a>
                </div>
            </div>
        </div> --}}
{{-- 
        <div class="col-lg-12">
            <div class="row row-cols-1 row-cols-lg-5 g-4 border-team">
                ...
                <div class="team-wrapper-v2">
                    ...
                    <span>{{ $sharlenetitle[$lang] }}</span>
                    <br><i class="fas fa-info" data-bs-toggle="tooltip" data-bs-placement="right" title="{{ $sharbio[$lang] }}"></i>
                    <a href="https://www.linkedin.com/in/sharleneputihrai/" target="_blank"><i class="fab fa-linkedin"></i></a>
                </div>
                <div class="team-wrapper-v2">
                    <img src="{{ url('assets/img/team/heryagus.webp') }}" alt="Heryagus Photo">
                    <p>Heryagus</p>
                    <span>{{ $herytitle[$lang] }}</span>
                    <br><i class="fas fa-info" data-bs-toggle="tooltip" data-bs-placement="right" title="{{ $herybio[$lang] }}"></i>
                    <a href="https://www.linkedin.com/in/heryagus-yeo-74963b177/" target="_blank"><i class="fab fa-linkedin"></i></a>
                </div>
                <div class="team-wrapper-v2">
                    <img src="{{ url('assets/img/team/mikaila.webp') }}" alt="Mikaila Photo">
                    <p>Mikaila Pranaya Wibowo</p>
                    <span>{{ $mikailatitle[$lang] }}</span>
                    <br><i class="fas fa-info" data-bs-toggle="tooltip" data-bs-placement="right" title="{{ $mikailabio[$lang] }}"></i>
                    <a href="https://www.linkedin.com/in/mikaila-pranaya-wibowo-4b1b84229/" target="_blank"><i class="fab fa-linkedin"></i></a>
                </div>
                <div class="team-wrapper-v2">
                    <img src="{{ url('assets/img/team/jacqueline.webp') }}" alt="Jacqueline Photo">
                    <p>Jacqueline Natasha</p>
                    <span>{{ $jacqtitle[$lang] }}</span>
                    <br><i class="fas fa-info" data-bs-toggle="tooltip" data-bs-placement="right" title="{{ $jacqbio[$lang] }}"></i>
                </div>
                <div class="team-wrapper-v2">
                    <img src="{{ url('assets/img/team/irawan.webp') }}" alt="Irawan Photo">
                    <p>Irawan Ariseno</p>
                    <span>{{ $irawantitle[$lang] }}</span>
                    <br><i class="fas fa-info" data-bs-toggle="tooltip" data-bs-placement="right" title="{{ $irawanbio[$lang] }}"></i>
                </div>
                <div class="team-wrapper-v2">
                    <img src="{{ url('assets/img/team/natalie.webp') }}" alt="Natalie Photo">
                    <p>Natalie Suryadi</p>
                    <span>{{ $natalietitle[$lang] }}</span>
                    <br><i class="fas fa-info" data-bs-toggle="tooltip" data-bs-placement="right" title="{{ $nataliebio[$lang] }}"></i>
                    <a href="https://www.linkedin.com/in/natalie-suryadi/" target="_blank"><i class="fab fa-linkedin"></i></a>
                </div>
                <div class="team-wrapper-v2">
                    <img src="{{ url('assets/img/team/josephine.webp') }}" alt="Josephine Photo">
                    <p>Josephine Henata</p>
                    <span>{{ $josephinetitle[$lang] }}</span>
                    <br><i class="fas fa-info" data-bs-toggle="tooltip" data-bs-placement="right" title="{{ $josebio[$lang] }}"></i>
                    <a href="https://www.linkedin.com/in/josephine-henata-a205851a1/" target="_blank"><i class="fab fa-linkedin"></i></a>
                </div>
                <div class="team-wrapper-v2">
                    <img src="{{ url('assets/img/team/danar.webp') }}" alt="Danar Photo">
                    <p>Danar Respati</p>
                    <span>{{ $danartitle[$lang] }}</span>
                    <br><i class="fas fa-info" data-bs-toggle="tooltip" data-bs-placement="right" title="{{ $danarbio[$lang] }}"></i>
                    <a href="https://www.linkedin.com/in/danar-respati-8b64a21ba/" target="_blank"><i class="fab fa-linkedin"></i></a>
                </div>
            </div>
             --}}
        </div>
